  ...
  return (
    <nav className="bg-white p-6 shadow-md border-b border-gray-200 sticky top-0 z-50">
      <div className="container mx-auto flex justify-center items-center relative">
        ...
        {/* Logo Centered */}
        <h1 className="text-gray-800 text-3xl font-bold tracking-wide mx-5">Logo</h1>
        ...
        <ul className="hidden md:flex space-x-8">
          <li 
            className="relative"
            onMouseEnter={() => {
              clearTimeout(timeoutId); // Prevents the dropdown from closing instantly
              setAboutOpen(true);
            }}
            onMouseLeave={() => {
              timeoutId = setTimeout(() => setAboutOpen(false), 300); // Delay hiding dropdown
            }}
          >
            <a href="#" className="text-gray-600 text-lg font-medium hover:text-gray-900 transition duration-300 border-b-2 border-transparent hover:border-gray-900">
              About Us
            ...
            {aboutOpen && (
              <ul 
                ...
                onMouseEnter={() => clearTimeout(timeoutId)} // Keeps dropdown open when hovered
                onMouseLeave={() => setAboutOpen(false)} // Hides dropdown when leaving
              >
                <li>
      ...
      {isOpen && (
        <ul className="md:hidden bg-white w-full absolute left-0 top-16 shadow-md">
          <li>
            <a href="#" className="block text-gray-600 text-lg font-medium hover:text-gray-900 transition duration-300 p-4">
              Jewellery
            </a>
          </li>
          <li>
